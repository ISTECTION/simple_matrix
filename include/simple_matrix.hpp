...
namespace simple {
    ...
    /** @fn matrix<T> operator+ (const matrix<T>&, const matrix<T>&)
      * @brief  Перегрузка операции сложения матрицы с матрицей
      * @tparam T Любые целочисленные и вещественные типы
    ...
    /** @fn matrix<T> operator- (const matrix<T>&, const matrix<T>&)
      * @brief  Перегрузка операции вычитания матрицы из матрицы
      * @tparam T Любые целочисленные и вещественные типы
      * @param A Матрица расположенная слева от операции
      * @param B Матрица расположенная справа от операции
      * @return Копия экземляра класса
    ...
    /** @fn matrix<T> operator* (const matrix<T>&, const matrix<T>&)
      * @brief  Перегрузка операции умножения матрицы на матрицу
      * @tparam T Любые целочисленные и вещественные типы
      * @param A Матрица расположенная слева от операции
      * @param B Матрица расположенная справа от операции
      * @return Копия экземляра класса
    ...
    /** @fn matrix<T> operator* (const matrix<T>&, T)
      * @brief  Перегрузка операции умножения матрицы на коэффициент,
    ...
    /** @fn matrix<T> operator/ (const matrix<T>&, T)
      * @brief  Перегрузка операции деления матрицы на коэффициент,
      * расположенный правее от матрицы
      *
      * @tparam T Любые целочисленные и вещественные типы
      * @param  A    Матрица расположенная слева от операции
